...
The test oracles generated by AGORA+ have revealed dozens of bugs in APIs with millions of users: Amadeus Hotel, 
Deutschebahn, FDIC, Foursquare, GitHub, GitLab, Marvel, NYTimesBooks, OMDb, RESTCountries and YouTube. 
...
# Publication
AGORA+ has been accepted for publication in [*ACM Transactions on Software Engineering and Methodology*](https://doi.org/10.1145/3726524).

AGORA (the conference version of AGORA+) was accepted for publication in the technical track of 
...
This version of Daikon has been modified based on an analysis of a systematically collected dataset of 40 APIs (+700 operations) and its precision outperforms the one achieved by the default version of Daikon by a margin of more than 30% (in the context of REST APIs). This version of Daikon supports a total of 106 different types of invariants. 
