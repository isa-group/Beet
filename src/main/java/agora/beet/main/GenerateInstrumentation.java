...
public class GenerateInstrumentation {
    ...
    private static String openApiSpecPath = "src/test/resources/examples/GitLab/oas_jobs.yaml";
    private static String testCasesFilePath = "src/test/resources/examples/GitLab/test_cases.csv";
