...
public class GenerateInstrumentation {
    ...
    private static String openApiSpecPath = "src/test/resources/Stripe/oas.yaml";
    private static String testCasesFilePath = "src/test/resources/Stripe/Stripe_PostProducts_test.csv";
